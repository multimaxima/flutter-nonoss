...
class KkprLahan extends StatefulWidget {
  final int id;
  final String nama;

  const KkprLahan(this.id, this.nama, {super.key});

  @override
  State<KkprLahan> createState() => _KkprLahanState();
}

class _KkprLahanState extends State<KkprLahan> {
            ...
            child: ListView(
              children: [
                ...
                TextFormField(
                  ...
                  decoration: const InputDecoration(
                    labelText:
                        "Keadaan Tanah Sesuai Yang Tertulis Dalam Dokumen",
                    labelStyle: TextStyle(fontSize: 13),
                  ),
                  validator: (value) {
                    if (value == "") {
                          ...
                          onPressed: () async {
                            if (_formKey.currentState!.validate()) {
                              ...
                              var request = http.MultipartRequest(
                                  'POST', Uri.parse("$baseUrl/api/kkpr-lahan"));
