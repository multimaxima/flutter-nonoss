                ...
                child: Column(
                  children: [
                    if (reklame["hasil_staf"] == 2) ...[
                      Html(
                          data: "<b>${reklame["catatan_staf"].toString()}</b>"),
