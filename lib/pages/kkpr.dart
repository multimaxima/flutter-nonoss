                    ...
                    DropdownSearch<PemohonKkprModels>(
                      asyncItems: (String filter) async {
                        ...
                        if (response.statusCode != 200) {
                          ...
                          for (var element in pemohon) {
                            pemohonList
                                .add(PemohonKkprModels.fromJson(element));
                          }
                      ...
                      onChanged: (value) {
                        setState(() {
                          ...
                          _jenisPemohon.text =
                              value?.jenis.toString() as String;
                          varNib = value?.nib;
                          varNpwp = value?.npwp;
                      ...
                      child: ElevatedButton.icon(
                        onPressed: () async {
                          if (_permohonanKey.currentState!.validate()) {
                            ...
                            Map<String, dynamic> hasil = json
                                .decode(request.body) as Map<String, dynamic>;
                          ...
                          child: Padding(
                            ...
                            child: Column(
                              ...
                              children: <Widget>[
                                ...
                                if (legalList[itemIndex].suketWaris !=
                                    null) ...[
                                  const Divider(
                                      height: 20,
                                      thickness: 1,
                                ...
                                if (legalList[itemIndex].pinjamPakai !=
                                    null) ...[
                                  const Divider(
                                      height: 20,
                                      thickness: 1,
                                ...
                                if (legalList[itemIndex].petaBidang !=
                                    null) ...[
                                  const Divider(
                                      height: 20,
                                      thickness: 1,
                        ...
                        onPressed: () async {
                          if (_dokumenKey.currentState!.validate()) {
                            ...
                            var request = http.MultipartRequest(
                                'POST',
                                Uri.parse(
                                    "$baseUrl/api/kkpr-kirim-permohonan"));
